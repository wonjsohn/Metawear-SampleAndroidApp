...
public class ScannerGetNameActivity extends AppCompatActivity implements ScannerCommunicationBus {
    public static final String EXTRA_DEVICE= "com.mbientlab.metawear.app.ScannerGetNameActivity.EXTRA_DEVICE";
...
//        getApplicationContext().bindService(new Intent(this, MetaWearBleService.class), this, BIND_AUTO_CREATE); // don't bind here.
    }
...
//                Intent navActivityIntent = new Intent(ScannerGetNameActivity.this, NavigationActivity.class);
...
//        mwBoard.connect();
        ...
        result.putExtra(EXTRA_DEVICE, btDevice); // passing device thru intent?
        setResult(RESULT_OK, result); //"result" propagate back to activity (return to the caller)
        finish();
    }
